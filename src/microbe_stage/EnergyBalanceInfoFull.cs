...
///   </para>
///   <para>
///     This inherits from EnergyBalanceInfoSimple, but also tracks the consumption and production
///   </para>
/// </remarks>
public class EnergyBalanceInfoFull : EnergyBalanceInfoSimple
{
    ...
    public override void AddConsumption(string groupName, float amount)
    {
    ...
    public override void SetupTrackingForRequiredCompounds()
    {
        if (ProductionRequiresCompounds == null)
        {
            ProductionRequiresCompounds = [];
        }
        else
        {
